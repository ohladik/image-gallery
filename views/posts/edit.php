<main class="form-container <?php echo $GLOBALS['theme'] ?>">
    <form
            ...
            action="index.php?controller=posts&action=edit_submit&post_id=<?php echo $post_id; ?>"
            method="post"
            onsubmit="return validateForm()"
    >
        <span class="form-title <?php echo $GLOBALS['theme'] ?>">Edit post</span>
        ...
        <div class="form-input-container">
            ...
            <label class="<?php echo $GLOBALS['theme'] ?>" for="form-change-picture">Change picture?</label>
            <input id="form-change-picture" name="form-change-picture" type="checkbox">
            <input class="form-change-picture-input <?php echo $GLOBALS['theme'] ?>" type="file" name="picture" id="image" accept="image/*"/>
        ...
        <div class="form-button-container">
            <button name="edit" class="form-button" type="submit">Edit</button>
            <button name="delete" class="form-button delete" type="submit">Delete</button>
        </div>
    </form>
</main>
...
<script>
    ...
    function validateImage() {
        ...
        var changeInitiated = document.getElementById('form-change-picture').checked;
        if (changeInitiated && imagePath === '') {
            ...
            if (changeInitiated && validExtensions.indexOf(fileExtension) === -1) {
                errors.push({ element: 'image-form-error',
                    message: 'Allowed file formats are PNG, JPG, JPEG, GIF and BMP.' });
            }
        }
